...
# Ian Sanchez,11.13.2019, Modified code to complete assignment 6
# ------------------------------------------------------------------------ #
...
class FileProcessor:
    ...
    @staticmethod
    def ReloadDataFromFile():
        """
        Desc - Loads current data from the file
...
class IO:
    ...
    @staticmethod
    def AddANewItem(list_of_rows):
        """ Adds a new item in the list of dictionaries rows
    ...
    @staticmethod
    def RemoveAnExistingItem(list_of_rows):
        """ Removes an item in the list of dictionaries row
...
except: #creates the file if it does not exist
...
while(True):
    ...
    # Step 3.2 - Add a new item to the list/Table
        ...
        IO.AddANewItem(lstTable) # Asks user for input and adds it to list/table
        IO.ShowCurrentItemsInList(lstTable)  # Show current data in the list/table
        continue  # to show the menu
    ...
    # Step 3.3 - Remove a new item to the list/Table
        ...
        IO.RemoveAnExistingItem(lstTable) # Removes an existing item in the list/table
        IO.ShowCurrentItemsInList(lstTable)  # Show current data in the list/table
        continue  # to show the menu
    ...
    # Step 3.4 - Save tasks to the ToDoFile.txt file
        ...
        IO.ShowCurrentItemsInList(lstTable)  # Show current data in the list/table
        FileProcessor.SaveDataToFile(strFileName) # Prompts user if they want to save to file
        continue  # to show the menu

    # Step 3.5 - Reload data from the ToDoFile.txt file (clears the current data from the list/table)
    elif (strChoice == '5'):

        FileProcessor.ReloadDataFromFile()
        continue  # to show the menu
